...
public class _01_SearchingAndSortingAlgorithmsTest {
	...
	public void testSearch() {
		...
		assertNotEquals(8, Algorithms.findBrokenEgg(eggs));
	}
...
//	4. Create a method that will find the longest word.
    ...
    public void testSort() throws Exception {
        ...
        assertEquals(38.4, Algorithms.sortScores(results, 0), 0.0);
        assertEquals(40.7, Algorithms.sortScores(results, 1), 0.0);
        assertEquals(95.0, Algorithms.sortScores(results, 13), 0.0);
    }
